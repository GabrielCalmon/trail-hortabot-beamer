...
\begin{frame}[t]{Objetivos Específicos}
    ...
    \begin{columns}
        ...
        \column{1.8\textwidth}
                ...
                %dfsfdfs \\
                \Large{ Realizar o estudo do estado da arte \\ \vspace*{\vertspaceobjesp}
                Desenvolver modelo conceitual               \\ \vspace*{\vertspaceobjesp}
                Desenvolver requisitos técnicos             \\ \vspace*{\vertspaceobjesp}
                Desenvolver sistema de visão computacional  \\ \vspace*{\vertspaceobjesp}
                Desenvolver mecanismo CNC de movimentação   \\ \vspace*{\vertspaceobjesp}
