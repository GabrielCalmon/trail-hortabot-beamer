...
\begin{frame}[c]{Roadmap}
    ...
    \begin{tabular}{cccc}
        \rule{30pt}{0ex}  &   \includegraphics[width=.2\textwidth ]{element.png} & \rule{15pt}{0ex} \includegraphics[width=.2\textwidth]{notion.png} \rule{15pt}{0ex}& \includegraphics[width=.2\textwidth]{github.png}\\
    \end{tabular}

    \begin{tabular}{ccc}
        \phantom{This text invisible pp} &   \includegraphics[width=.2\textwidth]{trello.png} \rule{5pt}{0ex}& \includegraphics[width=.2\textwidth]{project-libre.png} \\
    \end{tabular}
%*----------- notes
    \note[item]{Notes can help you to remember important information. Turn on the notes option.}
\end{frame}
